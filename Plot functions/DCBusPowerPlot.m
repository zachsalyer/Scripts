...
title('DC Bus Power');
plot(CoreData.Powertrain.BatteryPack.BusVoltage.time,CoreData.Powertrain.BatteryPack.BusVoltage.data.*CoreData.Powertrain.BatteryPack.BusCurrent.data/1000,'LineWidth',2);
xlabel('Time [s]');
ylabel('Power [kW]');
end
